class TournamentsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @tournament.update(tournament_params)
        # binding.pry
        # @tournament.players << tournament_params[:player_ids] if tournament_params[:player_ids]
        # Tournament_Player.create!(tournament_player_params)
        # binding.pry
  ...
  private
    ...
    def tournament_params
      params.require(:tournament).permit(:name, :course_name, :date, player_ids:[])
    end
